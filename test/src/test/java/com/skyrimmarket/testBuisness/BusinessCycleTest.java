...
public class BusinessCycleTest {
    ...
    void completeOrderCycle() throws InterruptedException {
        ...
        masterOrderPage.commentText.sendKeys("Неверные данные, следует изменить титул на 'Ярл'");
        ...
        TimeUnit.MILLISECONDS.sleep(100);
        employeeMyOrderPage.wheresItemEdit.sendKeys("Под кроватью в первой комнате таверны Ривервуда");
        TimeUnit.MILLISECONDS.sleep(100);
        employeeMyOrderPage.commentEdit.sendKeys("Выполнен");
        TimeUnit.MILLISECONDS.sleep(100);
